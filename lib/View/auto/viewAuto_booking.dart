...
class ViewAutoBooking extends StatefulWidget {
  @override
  _ViewAutoBookingState createState() => _ViewAutoBookingState();
}

class _ViewAutoBookingState extends State<ViewAutoBooking> {
  final dbRef = FirebaseDatabase.instance.reference().child("Auto_Booking");
                                        ...
                                        return showDialog<void>(
                                          ...
                                          builder: (BuildContext context) {
                                            return AlertDialog(
                                              ...
                                              content: new Text(
                                                  'Do you want to dismiss this Auto ?'),
                                              actions: <Widget>[
